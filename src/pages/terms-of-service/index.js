...
function TermsOfService() {
  return (
    <div className="tos">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Portfolio | Victor Daramola.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Portfolio | Victor Daramola,
            accessible from{" "}
            <a
              href="victordaramola.com"
      ...
      <ul>
        <li>By email: victorddaramola@gmail.com</li>
      </ul>
    </div>
  );
}
